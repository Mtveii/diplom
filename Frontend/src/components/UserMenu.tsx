        ...
        >
          ...
          <div className="pt-1.5">
            ...
            <button
              onClick={() => {
                setOpen(false)
                void authApi.logout().finally(() => navigate('/login', { replace: true }))
              }}
              className="flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-sm text-danger-400 transition-colors hover:bg-danger-950/40 hover:text-danger-300"
            >
